	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				...
				'display-xl': ['3.75rem', { lineHeight: '1.1', letterSpacing: '-0.05em' }],
				'display-lg': ['3rem', { lineHeight: '1.2', letterSpacing: '-0.025em' }],
				'display-md': ['2.25rem', { lineHeight: '1.2', letterSpacing: '-0.025em' }],
				'display-sm': ['1.875rem', { lineHeight: '1.3', letterSpacing: '-0.025em' }],
			},
			colors: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(var(--oxos-primary) / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(var(--oxos-primary) / 0.6)'
					}
				}
			},
			animation: {
